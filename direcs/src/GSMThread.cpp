...
/* @todo: implement this in direcsstm !
			//---------------
			// motor sensors
			//---------------
...
int GSMThread::convertToDistance(int sensorValue)
{
...
int GSMThread::convertToSensorValue(int distance)
{
	unsigned char calibrationValue = 8;
...
int GSMThread::getMAmpere(int sensor)
{
...
float GSMThread::getVoltage(int sensor)
{
...
int GSMThread::getContactValue(int contact)
{
...
int GSMThread::getIrSensorValue(int sensor)
{
...
int GSMThread::getDistance(int sensor)
{
	int distance = 0;
...
int GSMThread::getDrivenDistance(int sensor)
{
...
bool GSMThread::resetDrivenDistance(int sensor)
{
...
int GSMThread::getUsSensorValue(int sensor)
{
...
int GSMThread::getMotorSensorValue(int sensor)
{
	//
...
/*
int GSMThread::getCompassValue(unsigned char axis)
{
	switch (axis)
	{
...
void GSMThread::setCompassState(bool state)
{
	// store the state within this class
	compassState = state;
}
...
float GSMThread::convertToDegree(int sensorValue)
{
...
void GSMThread::calculateHeading(void)
{
	if (xAxis == 0 && yAxis < 0)
	{
		heading = M_PI/2;
...
float GSMThread::convertToVolt(int sensor)
{
	if ((sensor < VOLTAGESENSOR1) || (sensor > VOLTAGESENSOR2))
	{
...
bool GSMThread::readInfraredSensor(short int sensor)
{
	int value = 0;
...
bool GSMThread::readUltrasonicSensor(short int sensor)
{
	int value = 0;
...
bool GSMThread::readVoltageSensor(short int sensor)
{
	int value = 0;
	QString answer = "error";
...
bool GSMThread::readMotorSensor(short int sensor)
{
	int value = 0;
	QString answer = "error";
...
bool GSMThread::readDrivenDistance(short int sensor)
{
	int value = 0;
	QString answer = "error";
...
bool GSMThread::readCompassAxis(short int axis)
{
	int value = 0;
	QString answer = "error";
...
bool GSMThread::readContact(short int contact)
{
	int value = 0;
