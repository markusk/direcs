...
class Direcs : public QObject
{
	...
	private:
		...
		*/
		...
		bool useRobotGUI; /// if true, we will use a small GUI for fitting on a small onboard TFT. By default this is decided by the local hostname of the system. @sa Gui::Gui()
