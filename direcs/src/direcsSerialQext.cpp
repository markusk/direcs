...
int DirecsSerialQext::openPort(char *dev_name, int baudrate)
{
	...
	if(spd != -1)
	{
		...
		{
			emit message(QString("<font color=\"#FF0000\">ERROR setting serial port input speed at DirecsSerialQext::openPort!</font>"));
			return -1;
		}

		if (cfsetospeed(&options, (speed_t) spd) != 0)
		{
			emit message(QString("<font color=\"#FF0000\">ERROR setting serial port output speed at DirecsSerialQext::openPort!</font>"));
			return -1;
		}
	}
	else
	{
		emit message(QString("<font color=\"#FF0000\">ERROR: Wrong value for speed parameter at DirecsSerialQext::openPort!</font>"));
		return -1;
	}
	...
	{
		emit message(QString("<font color=\"#FF0000\">ERROR fluhsing serial input buffer at DirecsSerialQext::openPort!</font>"));
		return -1;
	}
	...
	{
		emit message(QString("<font color=\"#FF0000\">ERROR setting serial port attributes at DirecsSerialQext::openPort!</font>"));
		return -1;
	}
